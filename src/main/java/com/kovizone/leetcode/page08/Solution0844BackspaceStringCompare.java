 ...
 * @since 2022/08/10
 */
public class Solution0844BackspaceStringCompare {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution0844BackspaceStringCompare().backspaceCompare("a#bb", "c#b"));
        System.out.println();
        System.out.println(new Solution0844BackspaceStringCompare().backspaceCompare("ab", "b"));
    }
