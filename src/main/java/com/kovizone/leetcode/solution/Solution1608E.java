 ...
 * @since 2022/08/09
 */
public class Solution1608E {

    public static void main(String[] args) {
        System.out.println(new Solution1608E().specialArray(new int[]{3, 9, 7, 8, 3, 8, 6, 6}));
        // 9 8 8 7 6 6 3 3
        // 7 >= 4 && c < 4
        System.out.println(new Solution1608E().specialArray(new int[]{3, 6, 7, 7, 0}));
    }
