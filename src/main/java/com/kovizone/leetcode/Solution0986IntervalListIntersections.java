 ...
 * @since 2022/08/10
 */
public class Solution0986IntervalListIntersections {

    public static void main(String[] args) {
        System.out.println(JSONUtil.toJsonStr(new Solution0986IntervalListIntersections().intervalIntersection(
                new int[][]{
                        new int[]{4, 6},
                        new int[]{7, 8},
                        new int[]{10, 17}
