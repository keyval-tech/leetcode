 ...
 * @since 2022/08/08
 */
public class Solution0744FindSmallestLetterGreaterThanTarget {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution0744FindSmallestLetterGreaterThanTarget().nextGreatestLetter(new char[]{'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'}, 'd'));
    }
}