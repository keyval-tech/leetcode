 ...
 * @since 2022/08/24
 */
public class Solution0797AllPathsFromSourceTarget {
    ...
    public static void main(String[] args) {
        System.out.println(JSONUtil.toJsonStr(new Solution0797AllPathsFromSourceTarget().allPathsSourceTarget(new int[][]{
                {4, 3, 1},
                {3, 2, 4},
                {3},
                {4},
