 ...
 *
 * @author KV
 * @see Solution0116PopulatingNextRightPointersEachNode
 * @since 2022/08/16
 */
public class Solution0117PopulatingNextRightPointersEachNode2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution0117PopulatingNextRightPointersEachNode2().connect(node).toString());
